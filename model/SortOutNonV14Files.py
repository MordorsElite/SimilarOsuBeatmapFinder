...
for i, osu_file_path in enumerate(tqdm(osu_file_paths)):
    osu_file_path = os.path.join(osu_files_dir, osu_file_path)
    ...
    with open(osu_file_path, 'r', encoding='UTF-8') as osu_file:
        ...
        if first_line == config['required_file_version']:
            ...
            shutil.move(os.path.join(osu_files_dir, osu_file_path), 
                        os.path.join(not_v14_dir, osu_file_path))
